...
\begin{proof}
	...
	\end{itemize}
			...
			So we can assume $r \perp p_n$ for all $n < \omega$.
			...
			So we have $r' \in D, r' \leq p_n$ for all $n< \omega$, which proves the density of $D$.
			...
			Since $V \models ZFC$ and $2^{\omega} \geq \omega_1$ is a theorem of ZFC, we also get 
...
\begin{proof}
	...
	As in the previous exercise, observe that $(2^{\omega})^V = (2^{\omega})^{V[G]}$ because $P$ is $\omega_1$-closed.
